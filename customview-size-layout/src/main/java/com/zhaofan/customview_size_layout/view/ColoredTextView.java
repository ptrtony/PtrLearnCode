...
public class ColoredTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final int CORNER_RADIUS = DisplayUtils.dpToPx(4);
    private static final int X_PADDING = DisplayUtils.dpToPx(16);
    private static final int Y_PADDING = DisplayUtils.dpToPx(8);
